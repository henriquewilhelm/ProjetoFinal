...
public class TelaJogador {
	...
	public TelaJogador(Jogador jogador) {
		...
		this.caixaMedalhas = new JPanel(new GridLayout(1,jogador.getVitorias()));
		...
		this.medalhas = new JLabel[jogador.getMedalhas()];
		for (int i =0; i<medalhas.length; i++){
			String dirMedalha = "img/medalhas/medalha" + Integer.toString((i+1)) + ".jpg";
			this.medalhas[i] = new JLabel(new ImageIcon(dirMedalha));
			this.caixaMedalhas.add(this.medalhas[i]);
		}
	...
	public JLabel[] getMedalhas() {
		return medalhas;
	}
	public void setMedalhas(JLabel[] medalhas) {
