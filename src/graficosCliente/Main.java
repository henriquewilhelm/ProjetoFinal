...
public class Main {
	...
	public static void main(String args[]) throws UnknownHostException,	IOException {
		...
		// Cria Telas do Jogo
		TelaTrilha telaTrilha = new TelaTrilha();
		TelaInicio telaInicio = new TelaInicio(cliente, telaTrilha);		
    	...
    	service.submit(new ThreadMonitoraTelas(jogador, cliente, cards, telaPrincipal.getTelaJogador(),
    			...
    			telaInicio.getTelaConexao(), telaOpcoes, telaRanking, telaInicio, telaTrilha));
