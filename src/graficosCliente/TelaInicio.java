...
public class TelaInicio {
	...
	public TelaInicio(Cliente cliente, TelaTrilha telaTrilha){
		...
		this.telaInformacoes.add(telaTrilha.getTelaTrilha());
	...
	public TelaTrilha getTelaTrilha() {
		return telaTrilha;
	}
	public void setTelaTrilha(TelaTrilha telaTrilha) {
		this.telaTrilha = telaTrilha;
	}
